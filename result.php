...
for ($i=1; $i<=10; $i++) // Find out attempted questions and store them in $attempted
{
	if(isset($_POST["a$i"]))
	{
		$attempted[] = $i;
...
$sql ='SELECT user_email from users where user_id='.$_SESSION['user_id']  ;
