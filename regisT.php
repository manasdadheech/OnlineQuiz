...
$regis= "INSERT INTO teacher(T_name, T_pass, T_email) VALUES ('$username','$password','$user_email')";
...
<?php
	...
	echo '<div class="info">If you have already registered please move to your  <a href="./teacher.php">Login page</a>.</div>';
